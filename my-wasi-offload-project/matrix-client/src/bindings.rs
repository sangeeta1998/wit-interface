        ...
        pub mod host_allocator {
            ...
            pub fn allocate_buffer(size: u64) -> Result<Handle, HostError> {
                unsafe {
                    ...
                    #[link(
                        wasm_import_module = "wasi-custom:host-offload/host-allocator@0.1.0"
                    )]
                    unsafe extern "C" {
...
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 775] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x8a\x05\x01A\x02\x01\
...
rix-dimensions\x01\x11\x03\0-wasi-custom:host-offload/host-allocator@0.1.0\x05\0\
\x01j\0\x01s\x01@\0\0\x01\x04\0\x12run-matrix-example\x01\x02\x04\0'my-org:matri\
x-client-world/client@0.1.0\x04\0\x0b\x0c\x01\0\x06client\x03\0\0\0G\x09producer\
